...
class SecurityHeaders
{
    ...
    private function getContentSecurityPolicy(): string
    {
        ...
        $policies = [
            ...
            "connect-src 'self' {$apiEndpoint} {$wsEndpoint} https://www.google-analytics.com https://stats.g.doubleclick.net",
            "media-src 'none'",
            "object-src 'none'",
            "frame-src 'none'",
            "base-uri 'self'",
        ...
        if (app()->environment('local', 'development')) {
            ...
            $policies = [
                ...
                "connect-src 'self' " . implode(' ', $localConnections) . " {$apiEndpoint} {$wsEndpoint} https://www.google-analytics.com https://stats.g.doubleclick.net",
                "media-src 'none'",
                "object-src 'none'",
                "frame-src 'none'",
                "base-uri 'self'",
